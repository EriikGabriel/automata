  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "data-active:bg-white dark:data-active:text-foreground dark:data-active:border-input dark:data-active:bg-white data-active:text-amethyst-500 data-active:font-bold p-2 data-active:hover:text-amethyst-500",
