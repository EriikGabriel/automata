    ...
    <Accordion defaultValue={["generate-regex", "generate-automata"]} multiple>
      <AccordionItem value="generate-regex" className="py-3">
        ...
        <AccordionContent className="flex flex-col gap-3">
          <Button
            size="lg"
            className="h-12 px-10 w-full border-none flex items-center hover:bg-amethyst-600/80 transition-all shadow shadow-amethyst-400"
          >
      ...
      <AccordionItem value="generate-automata" className="py-3">
        ...
        <AccordionContent className="flex flex-col gap-3">
          ...
          <Button
            size="lg"
            className="h-12 px-10 w-full flex items-center border-none hover:bg-amethyst-600/80 transition-all shadow shadow-amethyst-400"
          >
            <HugeiconsIcon className="size-5" icon={MagicWand01Icon} />
